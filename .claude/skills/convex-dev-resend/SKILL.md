...
> Agents: read this skill fully before writing code that uses Resend. Follow the installation and configuration steps exactly.
...
Current npm version: `@convex-dev/resend@0.2.5`
