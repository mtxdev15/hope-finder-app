...
'today.limitPlusCta': 'Ver planes',
    ...
    'plans.freeF1': 'La Biblia completa en 8 traducciones, con búsqueda y resaltados',
    'plans.freeF2': '3 respuestas de Guía Suave al día, unas 90 al mes',
    'plans.freeF3': '34 Caminos para recorrer, cinco días cada uno, 3 abiertos a la vez',
    'plans.freeLang': 'Todo en inglés y en español',
    'plans.plusReframe': 'Unos $2 por semana',
    'plans.rGuidanceD': 'Escribe lo que te pesa, con tus propias palabras. Recibes la Escritura que habla a eso, declaraciones para decir en voz alta y una oración para orar.',
    'plans.rActiveD': 'Un Camino son cinco días, caminando de un lugar a otro. Gratis mantiene tres abiertos a la vez para que termines lo que empiezas.',
    'plans.rCatalog': 'Caminos para elegir',
    'plans.rCatalogN': '34',
    'plans.rCatalogD': 'De la Vergüenza a Amado. De la Ansiedad a la Paz. Del Duelo a Consolado. Cada uno escrito, cinco días.',
    'plans.rNewD': 'No hay límite mensual para empezar uno. El único límite es cuántos mantienes abiertos al mismo tiempo.',
    'plans.rBible': 'La Biblia, 8 traducciones',
    'plans.rBibleD': 'ASV, ESV, KJV, NIV, NKJV, NLT, WEB y Reina-Valera. Búscala, léela por capítulos, resalta lo que te llegue.',
    'plans.rHighlights': 'Resaltados y versículos guardados',
    'plans.rHighlightsD': 'Marca un versículo mientras lees y ahí queda, con tus colores.',
    'plans.rVaultD': 'Palabras, versículos, declaraciones, oraciones y lo que escribiste en un Camino. Reúnelos en colecciones que tú nombras.',
    'plans.rLang': 'Inglés y español',
    'plans.rLangD': 'No es una capa de traducción sobre una app en inglés. Cada respuesta, cada Camino y cada correo está escrito en el idioma que elegiste.',
    'plans.q5': '¿Declare es gratis?',
    'plans.a5': 'Sí, y sigue siendo gratis. Sin pagar nada tienes 3 respuestas de Guía Suave al día, 34 Caminos con 3 abiertos a la vez, la Biblia completa en 8 traducciones y una Bóveda que guarda todo lo que salves. Plus quita el límite diario. No desbloquea la Escritura, porque la Escritura nunca estuvo bloqueada.',
    'plans.q6': '¿Qué es la Guía Suave?',
    'plans.a6': 'Escribes lo que te pesa, con tus propias palabras, tal como es. Recibes la Escritura que habla a eso, declaraciones para decir en voz alta y una oración para orar. Toma unos segundos y no hay nada que configurar.',
    'plans.q7': '¿Qué es un Camino?',
    'plans.a7': 'Cinco días caminando de un lugar a otro. De la Vergüenza a Amado. De la Ansiedad a la Paz. Del Duelo a Consolado. Hay 34, se abre un día a la vez, y lo que escribes queda en tu Bóveda.',
    'plans.q8': '¿Necesito una cuenta?',
    'plans.a8': 'No para empezar. Puedes nombrar una lucha y recibir Escritura sin registrarte. La cuenta es lo que te deja conservarlo: tu Bóveda, tus resaltados y los Caminos más allá del primer día.',
    'plans.q9': '¿Declare está en español?',
    'plans.a9': 'Sí, todo. Cada respuesta, cada Camino, cada correo y la Biblia misma, en Reina-Valera. No es una app en inglés con botones traducidos.',
    'plans.q10': '¿Hay una app para mi teléfono?',
    'plans.a10': 'Declare funciona en tu navegador y está hecha primero para el teléfono, así que no hay nada que descargar. En iPhone, toca Compartir y luego Añadir a pantalla de inicio, y se abre como cualquier otra app.',
    'plans.q11': '¿Lo que escribo es privado?',
    'plans.a11': 'Lo que escribes se usa para encontrarte Escritura y nada más. Nunca se vende, nunca se le muestra a nadie y nunca se usa para entrenar un modelo. Lo que guardas es tuyo y puedes borrarlo.',
    'plans.q12': '¿De verdad Lifetime nunca se renueva?',
    'plans.a12': 'Se compra una vez y no se renueva nada. No guardamos tu tarjeta, no hay nada que cancelar, y todo lo que Plus reciba en el futuro está incluido. La membresía fundadora está limitada a 200 personas.',
