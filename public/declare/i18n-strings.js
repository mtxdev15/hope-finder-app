...
window.__I18N_STRINGS = {
  es: {
    ...
    /* ---- /pricing (Phase 2 shell; Phase 10 builds the full sales page) ----
       Prices are numerals and stay identical in both languages, so only the
       words around them are translated. */
    'pricing.back': 'Atrás',
    'pricing.ttl': 'Planes',
    'pricing.h1': 'Declare sigue siendo gratis',
    'pricing.psub': 'La Palabra, tus declaraciones, tu Camino y tu Bóveda no cuestan nada y nunca costarán. Plus simplemente quita los límites diarios para quienes quieren más espacio.',
    'pricing.cycleAria': 'Ciclo de cobro',
    'pricing.monthly': 'Mensual',
    'pricing.annual': 'Anual',
    'pricing.freeNm': 'Gratis',
    'pricing.freeNote': 'Sin tarjeta. Sin una prueba que termina en silencio.',
    'pricing.freeF1': 'Escritura, declaraciones y oración sin límite',
    'pricing.freeF2': '2 Caminos activos a la vez',
    'pricing.freeF3': '3 respuestas de Guía Suave al día',
    ...
    'pricing.plusF2': 'Caminos activos sin límite',
    'pricing.plusCta': 'Disponible pronto',
    'pricing.plusFine': 'Plus aún no está abierto. Nada aquí te cobra.',
    'pricing.comingLbl': 'Próximamente en Plus',
    'pricing.comingBody': 'Estamos construyendo memorización de Escritura, una reflexión semanal, una línea de tiempo del Camino y exportaciones. Hoy no son parte de Plus, y no cobraremos por ellas antes de que existan.',
    'pricing.moreLbl': 'Para familias e iglesias',
    'pricing.famNm': 'Familia',
    'pricing.famD': 'Plus para todos bajo un mismo techo.',
    'pricing.comingSoon': 'Próximamente',
    'pricing.churchNm': 'Iglesia',
