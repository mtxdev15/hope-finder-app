    ...
    if (kind === "signup") {
      return {
        ...
        body: [
          ...
          "Tienes 3 respuestas de Guía Suave al día y 3 Caminos abiertos a la vez, de 5 días cada uno. Todo lo que guardes queda en tu Bóveda y es tuyo.",
  ...
  if (kind === "signup") {
    return {
      ...
      body: [
        ...
        "You have 3 Gentle Guidance responses a day and 3 Journeys open at a time, 5 days each. Everything you save goes to your Vault and stays yours.",
